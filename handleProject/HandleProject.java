...
public class HandleProject
{
   ...
   private final String fileExtension = ".callIDE"; // We can change this ******
    ...
    */
   public HandleProject( File build, File src, File mainClass, String projectPath) throws SecurityException
   {
    ...
    * @throws SecurityException if can't create src and build
    */
   public HandleProject( File build, File src, File mainClass, String projectPath, ArrayList<File> allJavaFiles) throws SecurityException
   {
    ...
    * @throws SecurityException if can't create src and build.
    */
   public void checkAndCreateFolders() throws SecurityException
   {
   ...
   public void saveProject( String path, String name) throws FileNotFoundException, IOException
   {
      ...
      FileOutputStream fileOut = new FileOutputStream( path + name + fileExtension);
   ...
   public void openProject( String path, String name ) throws FilesMismatchException, FileNotFoundException, IOException, ClassNotFoundException
   {
      ...
      FileInputStream fileIn = new FileInputStream( path + name + fileExtension );
