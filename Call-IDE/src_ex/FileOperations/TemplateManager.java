...
public class TemplateManager {
    ...
    public void createDefaults() throws IOException {
        copyDefault("/FileOperations/DefaultTemplates/ConsoleTemplate.dat", userPath + "/Templates/ConsoleTemplate");
        copyDefault("/FileOperations/DefaultTemplates/FrameTemplate.dat", userPath + "/Templates/FrameTemplate");
    }
    
    private void copyDefault( String source, String target) throws IOException {
